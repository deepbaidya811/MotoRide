...
export default function ForgotPassword() {
  ...
  const handleEmailSubmit = (e) => {
    ...
    // Here would be actual email verification logic
    setStep(2);
  };
    ...
    <div className="min-h-screen bg-white flex">
          ...
          {step === 1 ? (
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-6">
              ...
              <button
                type="button"
                onClick={() => setStep(1)}
                className="w-full bg-transparent text-black py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
              >
                Back
              </button>
            </form>
      ...
      <div className="hidden lg:flex flex-1 bg-black items-center justify-center p-8">
        <div className="max-w-md text-center">
          ...
          <p className="text-gray-400">Your account security is our priority</p>
        </div>
      </div>
    </div>
  );
